...
var managementvnetrtname = '${subscription(managementsubid)}-rt'
var identityvnetrtname = '${subscription(identitysubid)}-rt'
...
var securityvnetrtname = '${subscription(securitysubid)}-rt'
